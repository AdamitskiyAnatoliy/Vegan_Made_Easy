...
public class ResideMenu extends FrameLayout{
    ...
    private void initViews(Context context){
        ...
        layoutLeftMenu = (LinearLayout) findViewById(com.special.ResideMenu.R.id.layout_left_menu);
        layoutRightMenu = (LinearLayout) findViewById(com.special.ResideMenu.R.id.layout_right_menu);
